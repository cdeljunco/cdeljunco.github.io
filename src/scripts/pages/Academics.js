           ...
           <h2 class="title card__title card__title--academics">PhD Research</h2> 
            <div class="card__section">
                ...
                <figure class="figure onDesktop">
                    <img class="figure__image" src="https://www.clara-deljunco.net/files/bo-fig.png" alt="bo-fig">
                ...
                <figure class="figure onDesktop">
                    <img class="figure__image" src="https://www.clara-deljunco.net/files/bo-fig.png" alt="rb-fig">
                    <figcaption class="figure__caption">
