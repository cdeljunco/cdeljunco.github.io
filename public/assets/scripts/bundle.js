 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */;const M=new class{handleAttributeExpressions(t,e,n,i){const s=e[0];if("."===s){return new S(t,e.slice(1),n).parts}if("@"===s)return[new I(t,e.slice(1),i.eventContext)];if("?"===s)return[new V(t,e.slice(1),n)];return new k(t,e,n).parts}handleTextExpression(t){return new E(t)}};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
